...
def _get_total_story_points(project):
    return project.total_story_points is not None\
        and project.total_story_points\
        or sum(project.calculated_points["defined"].values())


def _get_total_milestones(project):
    return project.total_milestones is not None\
        and project.total_milestones\
        or project.milestones.count()
